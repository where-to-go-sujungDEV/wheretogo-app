...
(
  ...
  `price`   TEXT				NULL	DEFAULT NULL,
    ...
    `visitNum`       BIGINT    NULL        DEFAULT 0, 
     PRIMARY KEY (eventID)
);
...
"(재)강원세계산림엑스포조직위원회", '<a href="http://www.gwfe.or.kr" target="_blank" title="새창: 홈페이지로 이동">http://www.gwfe.or.kr</a>', "2023 강원세계산림엑스포는 오는 2023년 5월 4일부터 6월 6일까지 34일 동안 '세계, 인류의 미래, 산림에서 찾는다'라는 주제로 고성군 토성면
에 위치한 세계잼버리수련장과 설악~금강권을 연결하는 고성, 속초, 인제, 양양 일원에서 개최된다.", 
'강원도세계잼버리수련장', NULL, NULL, '보통권 :<br>일반(만 19세 ~ 64세) 10,000원(예매 8,000원)<br>청소년(만 13세 ~ 18세) 7,000원(예매 6,000원)<br>어린이(만 7세 ~ 12세) 5,000원(예매 4,000원)<br><br>단체권 :<br>일반(만 19세 ~ 64세) 8,000원<br>청소년(만 13세 ~ 18세) 6,000원<br>어
린이(만 7세 ~ 12세) 5,000원<br>※ 내국인 :<br>20명 이상 / 외국인 : 10명 이상, 예매요금 동일, 동시입장<br><br>우대권 :<br>일반(만 19세 ~ 64세) 5,000원(예매 5,000원)<br>청소년(만 13세 ~ 18세) 3,500원(예매 3,500원)<br>어린이(만 7세 ~ 12세) 2,500원(예매 2,500원)<br>※ 만 65세 ~74세, 경증(4~6급)장애인, 현역군경(의무복무자), 강원도민<br><br>가족권 : 24,000원(예매 20,000원)<br><br>※ 무료입장 : 국가(독립)유공자, 국민기초생 활수급자, 중증(1~3)급 장애인 및 보호자 1명, 만 75세 이상, 만 7세 미만, 공무수행자, 국빈외교사절단 및 수행자, 단체인솔자(20명당 1인), 학교단체 인솔 교사');
...
"현대차 정몽구 재단", '<a href="http://artvillage.or.kr/" target="_blank" title="새창 : 휴콘서트">www.artvillage.or.kr</a>', "현대차 정몽구 재단이 주최하고, 한국예술종합학교가 주관하며, 경기도 여주시가 함께하는 ‘2022 예술마을 프로젝트: 강천섬 휴[休]콘서트’가 오는 9월 17일(토) 
경기도 여주시 강천면 강천리 627, 강천섬 일대에서 열린다.", 
'강천섬 일대', NULL, NULL, '무료');
...
"고창군", '<a href="http://www.grff.co.kr/" target="_blank" title="새창 : 고창농촌영화제 ">http://www.grff.co.kr/</a>', "고창농촌영화제는 
국내 최초 농촌을 테마로 하며 오는10월28일(금) 개막식을 시작으로 30일(일)까지 3일간 개최된다. 공식홈페이지를 통해 사전예약으로 진행되며 한국장편경쟁, 단평경쟁등 다양한 시선의 영화상영 및 드라이브시네마를 진행해 차량안에서 친구 연인 가족 또는 욜로라이프에 맞는 추억을 선물한다.", 
NULL, NULL, NULL, '무료');
...
'관악구', '행사홈페이지 - <a href="https://www.ggcfest.com" target="_blank" title="새창: 관악 강감찬축제 홈페이지로 이동">www.ggcfest.com</a><br>
...
'수영구', '<a href="http://www.suyeong.go.kr/festival/index.suyeong" target="_blank" title="새창:광안리어방축제 홈페이지로 이동">http://www.suyeong.go.kr</a>', "[축제소개] 역사와 전통, 즐거움과 웃음이 가득한 축제!
...
'(재)광주비엔날레', '<a href="https://www.gwangjubiennale.org/gb/index.do" target="_blank" title="새창: 광주비엔날레 홈페이지로 이동">https://www.gwangjubiennale.org/gb/index.do</a>', '2년마다 열리는 국제현대미술제’인 광주비엔날레는 지난 1995년, 광복 50주년과‘미술의 해’를 기념
하고 한국 미술문화를 새롭게 도약시키는 한편 광주의 문화예술 전통과 5ㆍ18광주민중항쟁 이후 국제사회 속에 널리 알려지기 시작한 광주 민주정신
을 새로운 문화적 가치로 승화시키기 위하여 창설되었다. 창설 취지문에서 밝히고 있듯이 “광주비엔날레는 광주의 민주적 시민정신과 예술적 전통을 바탕으로 건강한 민족정신을 존중하며 지구촌시대 세계화의 일원으로 문화생산의 중심축” 으로서 역할을 모색해 왔다. 아울러 “동/서양의 평등한 역
사 창조와 21세기 아시아 문화의 능동적 발아를 위하여, 그리고 태평양시대 문화공동체를 위하여...” 미술이라는 표현형식을 빌어 여러 민족,국가,문화권 간의 문화적 소통의 폭을 넓혀 가고 있다. 따라서 광주비엔날레는 문화도시, 민주도시 광주가 문화발신지가 되어 한국-아시아-세계와 교류를 넓혀 나가는 국제 현대미술의 장이다.', 
...
"문화체육관광부", '<a href="https://booking.naver.com/booking/12/bizes/691208
...
UPDATE eventTBL set w1 = 10, w2 = 3, w3 = 0, w4 = 0, w6 = 0, m1 = 0, m2 = 0 , m3 = 0 , m4 = 1 , m6 = 2 where eventID = 141105;
UPDATE eventTBL set w1 = 0 , w6 = 0 ,m1 = 0,m2 = 100 , m3 = 100 , m4 = 0 , m6 = 2 where eventID = 506545;
UPDATE eventTBL set w1 = 10 ,w2 = 3 ,w3 = 21 , w4 = 0 , w6 = 0 , m1 = 6 , m2 = 0 , m3 = 0 ,m4 = 0 , m6 = 2 where eventID = 629718;
UPDATE eventTBL set w1 = 10 , w2 = 5 ,w3 = 0 , w4 = 0 , w6 = 1 , m1 = 0 , m2 = 0 , m3 = 0 ,m4 = 2 , m6 = 2 where eventID = 2561750;
UPDATE eventTBL set w1 = 0 ,w2 = 3 , w3 = 0 , w4 = 1 ,w6 = 0 , m1 = 4 , m2 = 0 , m3 = 9 , m4 = 0 , m6 = 2 where eventID = 2612274;
UPDATE eventTBL set w1 = 10 , w2 = 3 , w3 = 0 , w4 = 5 ,w6 = 0 , m1 = 0 ,m2 = 0 , m3 = 0 , m4 = 0 and m6 = 2 where eventID = 2713558;
UPDATE eventTBL set w1 = 10, w2 = 3 , w3 = 7 , w4 = 0 ,w6 = 0 , m1 = 0 , m2 = 0 ,m3 = 0 ,m4 = 0 ,m6 = 2 where eventID = 2786391;
UPDATE eventTBL set w1 = 8 , w2 = 9 , w3 = 0 , w4 = 0 ,w6 = 100 , m1 = 7 , m2 = 3,m3 = 0 , m4 = 0 ,m6 = 2 where eventID = 2809281;
UPDATE eventTBL set w1 = 1, w2 = 3,w3 = 5, w4 = 0, w6 = 0,m1 = 0 ,m2 = 0,m3 = 0 ,m4 = 0 ,m6 = 2 where eventID = 2819403;
UPDATE eventTBL set w1 = 10,w2 = 3 , w3 = 0 , w4 = 0 , w6 = 0 , m1 = 0 , m2 = 0 , m3 = 0 , m4 = 0 , m6 = 2 where eventID = 2829875;
