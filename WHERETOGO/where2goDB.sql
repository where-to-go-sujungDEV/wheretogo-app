...
CREATE TABLE `eventTBL` (
  ...
  `hashtag1` varchar(10) NOT NULL,
  `hashtag2` varchar(10) NOT NULL,
  `hashtag3` varchar(10) NOT NULL,
...
INSERT INTO `eventTBL` VALUES (5,'국제 스페셜 뮤직&아트페스티벌','강원도','태백시','축제', '음악', '감동', '음악', '미술', '스포츠', '2022-07-26 00:00:00', '2022-07-29 00:00:00', 3, 5, NULL, '강원도 평창 알펜시아 리조트', 'https://sokorea.or.kr/sok/culture.php', '무료', '매년 여름 평창에서 개최하고 있는 전 세계 유일의 발달장애 문화축제로써, 다양한 나라에서 모인 발달장애인 아티스트들과 비장애인들이 음악, 미술, 스포츠를 함께 즐기며 이를 통해 발달장애인들이 사회로 좀 더 포용 될 수 있도록 지원하는 국제적인 문화예술축제. 올해의 주제인 <우리, 여기, 다시 Again, We are here together>은 코로나19를 이겨내고 발달장애 아티스트 모두(우리)가 평창(여기)에서 (다시) 만나 축제의 장이 시작된다  라는 의미를 담았다. 3년 만에 대면 공연으로 개최되는 이번 페스티벌 콘서트에서 발달장애인 아티스트들의 음악적, 예술적 역량을 확인하시길 바란다.');
